...
export default function Tips() {
  return (
    <section className="flex text-white flex-col bg-slate-900 w-3/4 xs:flex-col xs:w-full xs:pb-4">
      <div className="flex flex-col justify-evenly h-full xs:w-screen xs:mt-10">
        <div className="ml-7 text-center">
          <h2 style={{ fontSize: "3rem" }} className="text-white">
            Tips para tu rodada
          </h2>
        </div>
        <div className="flex flex-row text-white text-lg p-7 gap-2 justify-evenly flex-wrap xs:flex-nowrap xs:flex-col xs:items-center">
          <TipsCard
